# -*- coding: utf-8 -*-
"""
Created on Sat Jul 19 18:04:22 2025
...
# -*- coding: utf-8 -*-
"""
Created on Fri Jul 18 16:13:57 2025
...
model_names = [
    'LinearRegression','RobustRegression','RidgeRegression','LassoRegression','ElasticNet','PolynomialRegression','SGDRegressor',
    'ANN','RandomForest','SVM','LGBM','XGBoost','KNN' ]

models= {name: pickle.load(open(f'{name}.pkl','rb')) for name in model_names}

results_df = pd.read_csv(r'C:\Swapna\Learning\PYTHON\FS DataScience\ML Projects\HousingPrice\model_evaluation_results.csv')
